...
3. If `python` is not available on your PATH in Windows, either install Python 3.11+ or run the script with a full Python executable path.
4. Optional: run `python -m pytest -q` to execute the automated test file if you have `pytest` installed.
